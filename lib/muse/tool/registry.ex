                      ...
                      input_schema: %{
                        ...
                        properties: %{
                          ...
                          repo: %{
                            type: "string",
                            description:
                              "Optional Ecto repo module name (e.g. 'MyApp.Repo'). Defaults to first available repo."
                          }
                        },
                        required: ["query"]
                      },
  ...
  @search_hex_docs_spec Spec.new!(
                          ...
                          input_schema: %{
                            ...
                            properties: %{
                              query: %{
                                type: "string",
                                description: "Search terms for hexdocs.pm (required)"
                              },
                              packages: %{
                                type: "array",
                                items: %{type: "string"},
                                description: "Optional list of packages to limit search to"
                              }
                            },
                            required: ["query"]
                          },
                   ...
                   input_schema: %{
                     ...
                     properties: %{
                       tail: %{
                         type: "integer",
                         description:
                           "Number of recent entries to return (0 returns all, capped at 200)"
                       },
                       grep: %{
                         type: "string",
                         description: "Optional regex pattern to filter messages"
                       },
                       level: %{
                         type: "string",
                         enum: [
