defmodule Muse.CommandDispatcher do
  ...
  def dispatch(:workspace, args, context),
    do: WorkspaceCommands.dispatch(:workspace, args, context)
  ...
  def dispatch(:memory, args, context), do: MemoryCommands.dispatch(:memory, args, context)

  def dispatch(:memory_compact, args, context),
    do: MemoryCommands.dispatch(:memory_compact, args, context)

  def dispatch(:memory_clear, args, context),
    do: MemoryCommands.dispatch(:memory_clear, args, context)
  ...
  def dispatch(:workspace_list, args, context),
    do: WorkspaceCommands.dispatch(:workspace_list, args, context)

  def dispatch(:workspace_switch, args, context),
    do: WorkspaceCommands.dispatch(:workspace_switch, args, context)

  def dispatch(:workspace_create, args, context),
    do: WorkspaceCommands.dispatch(:workspace_create, args, context)

  def dispatch(:workspace_info, args, context),
    do: WorkspaceCommands.dispatch(:workspace_info, args, context)
