defmodule Muse.Commands do
  ...
  @slash_commands [
    ...
    {"/approve remote", :approve_remote,
     "Approve pending remote execution request (audit-only; no runner execution granted)"},
    {"/reject remote", :reject_remote, "Reject pending remote execution request"},
