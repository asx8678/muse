defmodule Muse.Approval do
  ...
  @type t :: %__MODULE__{
          ...
          command_hash: String.t() | nil,
          argv_preview: String.t() | nil,
  ...
  def new(attrs) when is_map(attrs) do
    ...
    %__MODULE__{
      ...
      target_id: normalize_optional_string(Map.get(normalized, :target_id)),
      command_hash: normalize_optional_string(Map.get(normalized, :command_hash)),
      argv_preview: normalize_optional_string(Map.get(normalized, :argv_preview)),
