...
>
> This document is the **source/roadmap plan** (v3.0 FINAL, generated 2026-05-03) and is preserved as-is for
> historical reference. It contains aspirational roadmap text (e.g., "Plan approved. Coding Muse will prepare
> a patch") that describes **future or planned** behavior. Some examples and milestone descriptions may not
> reflect current implemented behavior.
>
> **For current implemented behavior, see:**
> - [`PLAN.md`](../PLAN.md) — active PR roadmap and milestone definitions
> - [`docs/architecture.md`](../docs/architecture.md) §0 (PR09 ApprovalGate MVP — Implemented Contract) —
>   authoritative description of the approval gate, what is lifecycle-only, and what remains blocked/deferred
>
