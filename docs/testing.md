...
| **Fake provider planning flow** | `test/support/fixtures/fake_provider/planning_flow.jsonl` | Scripted planning flow used by fake-provider tests. |
| **Fake provider tool-call flow** | `test/support/fixtures/fake_provider/tool_calls_then_text.jsonl` | Scripted tool-call-then-text flow. |
