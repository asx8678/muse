...
- **Coding Muse can propose patches only after an approved plan.** The `patch_propose` tool is blocked for Planning Muse and only available to Coding Muse after plan approval.
